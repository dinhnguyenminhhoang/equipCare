...
import { priorityOptions, typeOptions } from "../../../utils/const";
import Button from "../../Common/Button/Button";
import Input from "../../Common/Input/Input";
import Select from "../../Common/Select/Select";

const ClientMaintenanceTicketForm = ({ onSubmit, onCancel, equipments }) => {
...
export default ClientMaintenanceTicketForm;
